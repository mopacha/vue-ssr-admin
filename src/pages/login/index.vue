<template>
	<div class="login-container">
		<div class="left" v-if="showLeft">
			<dir class="content">
				<div class="title"><span class="wel">Welcome to </span> <span class="the">Vue-SSR</span></div>
			...
			<el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
				...
				<el-form-item prop="username">
					<el-input
						...
						auto-complete="on"
					>
						<img slot="prefix" src="./img/user.svg" />
					</el-input>
				</el-form-item>
				<el-form-item prop="password">
					...
					>
						<img slot="prefix" src="./img/password.svg" />
						<span class="show-pwd" slot="suffix" @click="showPwd">
							<img v-if="passwordType === 'password'" src="./img/eye.svg" />
							<img v-else src="./img/eye-open.svg" />
						</span>
					</el-input>
				</el-form-item>
		...
		handleLogin() {
			this.$refs.loginForm.validate(valid => {
				if (valid) {
					...
					this.$store
						.dispatch('user/bahasaLogin', loginForm)
						.then(data => {
							this.success('登录成功')
